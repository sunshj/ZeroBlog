<template>
  <div class="h-screen flex-center flex-col">
    <div
      class="h-fit w-80 flex-center flex-col gap-4 border border-gray-200 rounded-xl border-solid p-6 shadow"
    >
      ...
      <button
        class="w-full flex-center cursor-pointer gap-2 border border-gray-300 rounded-md border-solid bg-black p-2 text-white transition-all ease-in-out"
